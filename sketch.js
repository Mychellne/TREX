...
rexcolidiu = loadAnimation("trex_collided.png");
...
function draw(){
 ...
 text("pontos: "+pontuacao,480, 50)
  ...
  chao.x=chao.width/2
   ...
   if ((touches.lenght > 0 || keyDown("space")) && rex.y >=100){
   ...
   //rex.changeAnimation("collided", rexcolidiu);
     
   rex.addAnimation("corendo",rexcolidiu);
